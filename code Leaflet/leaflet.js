 ...
 */
 ...
 }(this, function (t)
 {
 	...
 	function G(t, i, e, o)
 	{
 		...
 		{
 			st(t, a)
 		}), t.addEventListener(i, r, !1)) : "attachEvent" in t && t.attachEvent("on" + i, r) : F(t, r, s), t[le] = t[le] ||
 		{}, t[le][s] = r
 	}
 	...
 	var ve, ye, xe = (Object.freeze || Object)(
 		...
 		Le = ui.extend(
 		{
 			...
 			{
 				return e = void 0 === e ? this._zoom : this._limitZoom(e), t = this._limitCenter(C(t), e, this.options.maxBounds), n = n ||
 				{}, this._stop(), this._loaded && !n.reset && !0 !== n && (void 0 !== n.animate && (n.zoom = i(
 				{
 					animate: n.animate
 				}, n.zoom), n.pan = i(
 				{
 			...
 			flyTo: function (t, i, e)
 			{
 				...
 				if (!1 === (e = e ||
 					{}).animate || !Ni) return this.setView(t, i, e);
 				this._stop();
